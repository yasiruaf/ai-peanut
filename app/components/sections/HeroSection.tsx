  ...
  return (
    <>
      <section className="bg-[#141414] min-h-screen md:px-20 p-8 flex flex-col justify-center items-center">
        <div className=" w-full md:w-auto h-screen md:h-[750px] md:aspect-square rounded-2xl bg-neutral-950 relative flex flex-col items-center justify-center antialiased">
        <BackgroundBeams />
          <div className="max-w-2xl mx-auto ">
            <div className="mt-12">
              ...
              />
                <h1 className="text-6xl py-8 items-center text-center">$AiPnut</h1>
            </div>
          </div>
